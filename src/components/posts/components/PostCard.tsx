...
const PostCard = ({ post }: PostCardProps) => {
    return (
        <article className="flex flex-col sm:flex-row items-start justify-between py-6 border border-gray-500 last:border-b-0">
            <div className="flex-1 pr-0 sm:pr-8">
                ...
                {/* Meta data - Shows date, read time, and comment count */}
